...
* @returns {string}
*/
export function main2(command, program_json_str, air_public_input_json_str, _proof_file, _trace_file, _memory_file, _air_private_input_json_str) {
    let deferred8_0;
    let deferred8_1;
    try {
        ...
        const ptr1 = passStringToWasm0(program_json_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(air_public_input_json_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        var ptr3 = isLikeNone(_proof_file) ? 0 : passArray8ToWasm0(_proof_file, wasm.__wbindgen_malloc);
        var len3 = WASM_VECTOR_LEN;
        var ptr4 = isLikeNone(_trace_file) ? 0 : passArray8ToWasm0(_trace_file, wasm.__wbindgen_malloc);
        var len4 = WASM_VECTOR_LEN;
        var ptr5 = isLikeNone(_memory_file) ? 0 : passArray8ToWasm0(_memory_file, wasm.__wbindgen_malloc);
        var len5 = WASM_VECTOR_LEN;
        var ptr6 = isLikeNone(_air_private_input_json_str) ? 0 : passStringToWasm0(_air_private_input_json_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len6 = WASM_VECTOR_LEN;
        wasm.main2(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('sandstorm_cli_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
